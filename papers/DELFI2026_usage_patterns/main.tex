...
% For double-blind review submission, add `anonymous` to the class options:
%   \documentclass[biblatex, english, anonymous]{lni}
\documentclass[biblatex, english, anonymous]{lni}
...
% Anonymisation macros (expand to real names unless [anonymous] is set)
\newcommand{\mintgroup}{\anon[STEM Initiative]{MINT-the-GAP}}
\newcommand{\mintcol}{\anon[STEM]{MINT}}
...
\input{sections/02b_relatedwork}

\section{Dataset and Methodology}
\label{sec:methodology}
\input{sections/03_methodology}

\section{Feature Adoption in different contexts}
\label{sec:adoption}
