...
These findings could not be obtained solely through passive observation or user self-discovery. The methodology shows what a structured feedback mechanism within the development cycle for survereign educaional tolls which do not collect runtime data could look like.
